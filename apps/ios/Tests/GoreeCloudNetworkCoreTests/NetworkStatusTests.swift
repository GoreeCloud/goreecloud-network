...
@Test func decodesDevelopmentStatus() throws {
    let data = #"{"product":"GoreeCloud Network","version":"0.1.0-dev.3","lifecycle":"Development","surfaces":{"server":"development_persistent_control_plane","webDashboard":"development_dashboard","android":"development_client","googleTv":"development_client","ios":"development_client"}}"#.data(using: .utf8)!
...
@Test func decodesTruthfulOverview() throws {
    let data = #"{"deviceCount":0,"resourceCount":0,"policyCount":0,"policyMode":"deny_by_default","persistence":"development_file_store","schemaVersion":1,"revision":4,"migrationCount":1,"lastPersistedAt":"2026-09-11T23:00:00Z","integrity":"sha256","authentication":"not_implemented"}"#.data(using: .utf8)!
