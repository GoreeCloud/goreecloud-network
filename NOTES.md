...
- Android and Google TV build files target API 36 and use Android Gradle Plugin 9.3.1 with Kotlin 2.4.20; platform CI still requires execution on an Android SDK runner.
