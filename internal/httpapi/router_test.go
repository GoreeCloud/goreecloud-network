...
func TestStatusEndpoint(t *testing.T) {
	...
	if payload.Surfaces.Android != "source_bootstrap" || payload.Surfaces.GoogleTV != "source_bootstrap" || payload.Surfaces.IOS != "source_bootstrap" {
		t.Fatalf("client source states must remain truthful: %+v", payload.Surfaces)
	}
}
